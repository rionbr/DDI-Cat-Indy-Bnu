...
if __name__ == '__main__':
    ...
    path = '../../data/'
    dfi = pd.read_csv(path + 'indianapolis/age.csv', index_col='age_group')
    ...
    ri_cat, = ax.plot(age_inds, dfc['RI^{[y1,y2]}'].tolist(), marker='p', ms=6, lw=0, markerfacecolor=markerfacecolor_cat, markeredgecolor=markeredgecolor_cat, zorder=5)
    ...
    # Legend
    Ls = ax.legend(
        [ri_indy, ri_bnu, ri_cat],
        [r'$RI^{[y_1,y_2]}_{Indy}$', r'$RI^{[y_1,y_2]}_{Bnu}$', r'$RI^{[y_1,y_2]}_{Cat}$'],
